...
def create_ref_vcf(excel_table):
	...
	"""Create a BRCA1 reference vcf file containing the BRCA1_SGE_score (log2 scaled function scores) and BRCA1 SGE class (functional classification of the variant)
